...
class OfficialController extends Controller
{
    ...
    public function publicShow(Request $request, string $officialSlug)
    {
        ...
        return view('public.official-show', [
            ...
            'seoTitle' => $official->name.' | Profil Ofisial Liga Anak Pariaman',
            'seoDescription' => 'Profil publik ofisial '.$official->name.' dari '.($isHistoricalPublicSeason ? ($official->seasonClub?->name ?: 'Liga Anak Piaman Laweh') : ($official->club?->name ?: 'Liga Anak Piaman Laweh')).' di Liga Anak Piaman Laweh, liga sepak bola anak di Pariaman, dengan detail peran dan registrasi kompetisi.',
