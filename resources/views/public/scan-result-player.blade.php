...
<body>
    @php
        $clubModel = method_exists($player, 'seasonClub') && $player->seasonClub ? $player->seasonClub : $player->club;
    @endphp
    <div class="wrap">
        <div class="card">
            <div class="head">
            ...
            <div class="body">
                <div>
                    ...
                    @else
                        @php
                            $playerInitial = \Illuminate\Support\Str::of($player->name)->trim()->substr(0, 1)->upper();
                        @endphp
