...
<head>
    ...
    <meta property="og:image" content="{{ $official->photo_file_url ?: asset('android-chrome-512x512.png') }}">
    ...
    <meta name="twitter:image" content="{{ $official->photo_file_url ?: asset('android-chrome-512x512.png') }}">
    <style>
        :root {
            --bg: #f8fafc;
            --card: #ffffff;
