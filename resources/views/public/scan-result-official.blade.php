...
<head>
    ...
    <meta property="og:image" content="{{ $official->photo_file_url ?: asset('og-default.png') }}">
    ...
    <meta name="twitter:image" content="{{ $official->photo_file_url ?: asset('og-default.png') }}">
    <style>
        :root {
            --bg: #f8fafc;
            --card: #ffffff;
