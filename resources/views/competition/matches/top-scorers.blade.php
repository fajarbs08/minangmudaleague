    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-2">
                ...
                <li class="breadcrumb-item active" aria-current="page">Top Skor</li>
            </ol>
        </nav>
        <h4 class="mb-1">Top Skor</h4>
        <p class="text-muted mb-0">Daftar pencetak gol terbanyak dipisah ke page khusus agar ranking pemain lebih mudah dibaca.</p>
    </div>
    <div class="d-flex flex-wrap gap-2">
        <a href="{{ route('reports.top-scorers.pdf', $pdfQuery) }}" target="_blank" class="btn btn-primary">Buka PDF</a>
        <a href="{{ route('reports.top-scorers.pdf', array_merge($pdfQuery, ['download' => 1])) }}" class="btn btn-light">Unduh PDF</a>
        <button
            type="button"
            class="btn btn-outline-secondary position-relative d-inline-flex align-items-center gap-2"
            data-bs-toggle="offcanvas"
            data-bs-target="#topScorerFilterCanvas"
            aria-controls="topScorerFilterCanvas"
        >
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="topScorerFilterCanvas" aria-labelledby="topScorerFilterCanvasLabel">
    <div class="offcanvas-header">
        <div>
            <h5 class="offcanvas-title" id="topScorerFilterCanvasLabel">Filter Top Skor</h5>
    ...
    <div class="offcanvas-body">
        <form class="d-flex flex-column gap-3">
            <div>
                <label for="top-scorer-age-group-id" class="form-label">Kelompok usia</label>
                <select id="top-scorer-age-group-id" name="age_group_id" class="form-select">
            ...
            <div class="d-grid gap-2 mt-2">
                ...
                <a href="{{ route('reports.top-scorers') }}" class="btn btn-light">Reset Filter</a>
            </div>
        </form>
    </div>
</div>
