<div class="card">
    <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-3">
        <div>
            <h4 class="card-title mb-1">Tahapan Registrasi Klub</h4>
            <p class="text-muted mb-0">Panduan alur registrasi klub dalam format PDF.</p>
        </div>
