        ...
        <form method="POST" action="{{ route('information-resources.update', $resource) }}" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-6">
                    ...
                    <small class="text-muted d-block mt-2">Kosongkan jika file lama tetap dipakai. Format: PDF, JPG, JPEG, PNG, DOC, DOCX. Maks. 2 MB.</small>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-12">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="edit-is-published">Tampilkan di halaman club</label>
                    </div>
                </div>
