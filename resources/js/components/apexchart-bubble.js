...
const simpleBubbleColors = ["#1989df", "#7f56da", "#1bb394"];
...
const secondBubbleColors = ["#1989df", "#7f56da", "#f95c5c", "#1bb394"];
const secondBubbleOptions2 = {
    chart: {
        height: 380,
        type: 'bubble',
        toolbar: {
...
const secondBubbleChart = new ApexCharts(
    document.querySelector("#second-bubble"),
    secondBubbleOptions2
);

secondBubbleChart.render();